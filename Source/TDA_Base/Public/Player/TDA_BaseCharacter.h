...
#include "TDA_BaseCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class ATDA_BaseCharacter : public ACharacter
{
	GENERATED_BODY()
	...
	/** Pawn mesh: 3rd person view (FullCharactermesh) */
	UPROPERTY(VisibleDefaultsOnly, Category = Mesh)
	class USkeletalMeshComponent* Mesh3P;

	/** Gun mesh: 3rd person view  */
	UPROPERTY(VisibleDefaultsOnly, Category = Mesh)
		class USkeletalMeshComponent* 3P_Gun;
...
public:
	...
	TSubclassOf<class ATDA_BaseProjectile> ProjectileClass;
